 ...
 */
public interface ConcurrentMapWithValuedEviction<K, V> extends ConcurrentMap<K, V> {


    public static class Reply<K, V> {
        public int confidence; // confidence has 1: exact, 2:find nearest one/two, 3: find nothing
        public V lowerVal;
        public V higherVal;
        public V exactVal;
        public K lowerKey;
    ...
    /**
    * Do the fuzzy query. Find the nearest result.
     * use the flag to decide whether we need to add counter
    */
    ...
    /**
     *
     * @return the sum(importance) of the map, namely sum(freq*weight)
     */
    public long volumn();
